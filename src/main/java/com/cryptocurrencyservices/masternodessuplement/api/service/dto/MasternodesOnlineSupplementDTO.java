...
public class MasternodesOnlineSupplementDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MasternodesOnlineSupplementDTO masternodesOnlineSupplementDTO = (MasternodesOnlineSupplementDTO) o;
        if (masternodesOnlineSupplementDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), masternodesOnlineSupplementDTO.getId());
    }
    ...
    public String toString() {
        return "MasternodesOnlineSupplementDTO{" +
            "id=" + getId() +
            ", coin='" + getCoin() + "'" +
            ", price='" + getPrice() + "'" +
            ", change='" + getChange() + "'" +
